...
{
	//char retval[] = { 0xF0, 0x79, 0x01, 0x02, 0xF7, 0x00};
	    //Serial.write(retval, sizeof(retval));
  char buff[5] = {REPORT_VERSION, FIRMATA_MAJOR_VERSION, FIRMATA_MINOR_VERSION, 0xF7, 0x00};
  //FirmataStream->write(REPORT_VERSION);
  //FirmataStream->write(FIRMATA_MAJOR_VERSION);
  //FirmataStream->write(FIRMATA_MINOR_VERSION);

  FirmataStream->write(buff, sizeof(buff));
}
